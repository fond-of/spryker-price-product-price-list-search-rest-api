...
class PriceProductAbstractPriceListSearchResourceMapper implements PriceProductAbstractPriceListSearchResourceMapperInterface
{
    protected const SEARCH_KEY_PRICE_PRODUCT_PRICE_LISTS = 'price_product_abstract_price_lists';
