...
class PriceProductPriceListSearchRestApiConfig extends AbstractBundleConfig
{
    ...
    public const CONTROLLER_UNPAGINATED_PRICE_PRODUCT_CONCRETE_PRICE_LIST_SEARCH = 'price-product-concrete-price-list-search-resource';
    public const CONTROLLER_UNPAGINATED_PRICE_PRODUCT_ABSTRACT_PRICE_LIST_SEARCH = 'price-product-abstract-price-list-search-resource';
