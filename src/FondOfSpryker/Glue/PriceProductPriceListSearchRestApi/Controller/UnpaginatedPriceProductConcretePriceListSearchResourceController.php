 ...
 */
class UnpaginatedPriceProductConcretePriceListSearchResourceController extends AbstractController
{
    /**
    ...
    public function getAction(RestRequestInterface $restRequest): RestResponseInterface
    {
        return $this->getFactory()
            ->createUnpaginatedPriceProductConcretePriceListSearchReader()
